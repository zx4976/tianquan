...
# 一级学科关键词库（纯规则，零 LLM）— 与 Obsidian 科目体系一致
CATEGORY_KEYWORDS = {
    "数学": ["数学", "代数", "几何", "三角", "微积分", "微分", "积分", "方程", 
             "概率", "统计", "数论", "拓扑", "泛函", "复变", "实变", "分析",
             "不等式", "组合", "图论", "逻辑", "集合", "矩阵", "线性"],
    "物理科学": ["物理", "力学", "热学", "光学", "电磁", "量子", "相对论", 
                "天体", "粒子", "声学", "流体", "弹性"],
    "计算机科学": ["计算机", "编程", "程序", "算法", "数据结构", "操作系统", 
                  "网络", "数据库", "编译", "软件", "系统", "计算"],
    "金融与经济学": ["金融", "经济", "投资", "保险", "风险", "市场", "资本", 
                    "货币", "银行", "财政", "贸易"],
    "工程与技术": ["工程", "机械", "电子", "电气", "自动化", "通信", "材料",
                  "航天", "土木", "建筑", "控制"],
    "人文与社科": ["文学", "历史", "哲学", "宗教", "政治", "社会", "人类学",
                  "心理学", "教育", "法律", "艺术", "语言"],
}
