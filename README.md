...
- **图边权重递增** — 书与概念、概念与概念之间的关系权重随引用次数自动递增（Kremis 风格）
- **概念共现网络** — 同书内相邻概念自动建边，形成知识关联图
...
- **一键备份恢复** — 内置备份/恢复脚本，支持 SHA256 + BLAKE3 双校验
...
与 Obsidian 科目体系一致的六大学科自动分类：

| 学科 | 识别关键词 |
|------|-----------|
| 数学 | 代数/几何/微积分/概率/数论/拓扑/泛函/不等式/组合 |
| 物理科学 | 物理/力学/量子/电磁/热学/光学/相对论/流体 |
| 计算机科学 | 计算机/编程/算法/数据结构/网络/数据库/编译 |
| 金融与经济学 | 金融/经济/投资/风险/市场/资本/货币/银行 |
| 工程与技术 | 工程/机械/电子/电气/自动化/通信/材料/航天 |
| 人文与社科 | 文学/历史/哲学/宗教/政治/社会/心理/法律 |

标题关键词权重为正文的3倍，防止正文干扰。
